...
By default <tt>fields_for</tt> inside <tt>nested_form_for</tt> will add <div class="fields"> wrapper for every nested object. Sometimes you do not need it (for example if you insert <tr>-s into table). You can disable this functionality by providing <tt>:wrapper => false</tt> option (by default it is true):
